        ...
        public void SetDot(int i, int j, int dotColor)
        {
            ...
            try
            {
                for (int ii = 0; ii < 14; ii++)
                {
                    for (int jj = 0; jj < 14; jj++)
                    {
                        if ((grid[ii, jj] == dotColor && grid[ii + 1, jj + 1] == dotColor && grid[ii + 2, jj + 2] == dotColor && grid[ii + 3, jj + 3] == dotColor && grid[ii + 4, jj + 4] == dotColor) || (grid[ii, jj] == dotColor && grid[ii + 1, jj + 1] == dotColor && grid[ii + 2, jj + 2] == dotColor && grid[ii + 3, jj + 3] == dotColor && grid[ii + 4, jj + 4] == dotColor) || (grid[ii, jj] == dotColor && grid[ii + 1, jj - 1] == dotColor && grid[ii + 2, jj - 2] == dotColor && grid[ii + 3, jj - 3] == dotColor && grid[ii + 4, jj - 4] == dotColor))
                        {
                            ShowWin(dotColor);
                        }
                    }
